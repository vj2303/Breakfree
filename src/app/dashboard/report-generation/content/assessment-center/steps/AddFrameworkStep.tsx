          ...
          <div className="bg-white rounded-lg p-5 w-full max-w-2xl mx-4 max-h-[80vh] overflow-y-auto shadow-xl">
            ...
            <div className="mb-3">
              ...
              {selectedSubCompetency && (
                <>
                  <div className="mb-3">
                    <label className="block text-sm font-medium text-black mb-1.5">Score -1</label>
                    <textarea
                  ...
                  <div className="mb-3">
                    <label className="block text-sm font-medium text-black mb-1.5">Score -2</label>
                    <textarea
                      className="w-full p-2.5 border border-gray-300 rounded-md h-20 resize-none text-black text-sm"
                      placeholder="Enter score description..."
                  ...
                  <div className="mb-3">
                    <label className="block text-sm font-medium text-black mb-1.5">Score -3</label>
                    <textarea
                      className="w-full p-2.5 border border-gray-300 rounded-md h-20 resize-none text-black text-sm"
                      placeholder="Enter score description..."
              ...
              {activeCompetency.subCompetencies.map((sub, idx) => (
                <div key={idx} className="mb-4 pb-4 border-b border-gray-200 last:border-0">
                  ...
                  <div className="space-y-1.5 text-sm text-black">
                    <p className="text-gray-700">1. {scoreState[activeCompetency.id]?.[sub]?.score1 || 'No description added yet'}</p>
                    <p className="text-gray-700">2. {scoreState[activeCompetency.id]?.[sub]?.score2 || 'No description added yet'}</p>
                    <p className="text-gray-700">3. {scoreState[activeCompetency.id]?.[sub]?.score3 || 'No description added yet'}</p>
                  </div>
                </div>
              ))}
            </div>
