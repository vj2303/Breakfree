...
const SelectContentStep: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchContent = async (type: string) => {
      ...
      try {
        let url = "";
        if (type === "case-study") {
          url = "http://localhost:3001/api/case-studies?page=1&limit=10";
        } else if (type === "inbox-activity") {
          url = "http://localhost:3001/api/inbox-activities?page=1&limit=10";
        } else {
  ...
  //       ? `http://localhost:3001/api/case-studies/${activityId}`
  //       : `http://localhost:3001/api/inbox-activities/${activityId}`;
