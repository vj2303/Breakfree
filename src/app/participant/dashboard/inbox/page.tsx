...
const stepContent = [
  ...
  <OrganizationChartStep key="orgchart" />, 
  <TaskStep key="task" />
];
  ...
  return (
    <div className="mt-8 p-4">
      ...
      <div className="bg-white rounded-xl p-2 mb-6 shadow border">
        <h1 className="text-2xl font-bold mb-1">Display Name, <span className="font-normal text-lg">Inbox activity</span></h1>
        <div className="text-gray-500 text-sm mb-4">Date- DD/MM/YYYY</div>
        {/* Stepper */}
